      ...
      <div className='w-960 m-h-auto f-auto p-t-92 animated slideInRight'>
        <div className="f-l w-p-32 b-r-e h-p-100">
          <div>
            ...
            <div className='h-bg-e p-10 br-6 m-t-10'><i className='iconfont iconaddUser bg-blue inline-block wh-40 br-p-50 c-f fs-24 ta-c m-r-10 lh-40'/>添加关注</div>
            <div className='h-bg-e p-10 br-6'><img className='wh-40 m-r-10 va-m br-6' src="https://upload.jianshu.io/collections/images/4/sy_20091020135145113016.jpg" alt=""/>读书</div>
            <div className='h-bg-e p-10 br-6'><img className='wh-40 m-r-10 va-m br-6' src="https://upload.jianshu.io/collections/images/16/computer_guy.jpg" alt=""/>程序员</div>
          </div>
        </div>
